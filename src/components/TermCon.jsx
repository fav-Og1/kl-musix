...
export function TermsCon () {
 ...
 <div className='about-page'>
                <img src={termsCon}  className='about-pic'/>
                <div className='about-context'>
                   <h3>Terms and Condition</h3> 

<p>These terms and conditions outline the rules and regulations for the use of Kloudaa's Website, 
    located at www.kloudaa.com.
</p>  

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Kloudaa 
...
<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company's terms and conditions. 
    ...
    Our Terms and Conditions were created with the help of the Terms & Conditions Generator.
 </p>
...
<p>
    ...
    By accessing Kloudaa, you agreed to use cookies in agreement with the Kloudaa's Privacy Policy.
</p>
...
<h3> License </h3>
<p>
    Unless otherwise stated, Kloudaa and/or its licensors own the intellectual property rights for all material on Kloudaa. All intellectual property rights are reserved. 
    You may access this from Kloudaa for your own personal use subjected to restrictions set in these terms and conditions.
</p>
...
<p>
    Republish material from Kloudaa Sell, rent or sub-license material from Kloudaa Reproduce, duplicate or copy material from Kloudaa Redistribute content from Kloudaa .
    This Agreement shall begin on the date hereof.
</p>

<p>
    Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Kloudaa does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Kloudaa,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. 
    To the extent permitted by applicable laws, Kloudaa shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
</p>

<p>
    Kloudaa reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
<br />
...
<br />
You hereby grant Kloudaa a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
...
<p>
    ...
    and System wide Accredited Businesses except soliciting non-profit organizations, 
    ...
    so long as the link: <br />
    (a) is not in any way deceptive;
    <br /> (b) does not falsely imply sponsorship, 
...
<p>
    ...
    (b) the organization does not have any negative records with us;<br />
     (c) the benefit to us from the visibility of the hyperlink compensates the absence of Kloudaa; and <br />
...
<p>
    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Kloudaa. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, 
...
<p>
    By use of our corporate name; or By use of the uniform resource locator being linked to; or By use of any other description of our Website being linked to that makes sense within the context and format of content on the linking party's site.
     No use of Kloudaa's logo or other artwork will be allowed for linking absent a trademark license agreement.
</p>
